      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={() => router.push(`/admin/insights/loanofficers/${officerSlug}/leads`)}
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{lead.source?.replace('_', ' ').toUpperCase() || 'N/A'}</p>
                </div>
                <div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex-1 bg-gray-200 rounded-full h-2">
                      <div 
                        ...
                        style={{ width: `${(lead.leadQualityScore || 0) * 10}%` }}
                      ></div>
                    </div>
                    <span className="text-sm text-gray-600">{lead.leadQualityScore || 0}/10</span>
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{lead.responseTimeHours ? `${lead.responseTimeHours} hours` : 'N/A'}</p>
                </div>
                <div>
